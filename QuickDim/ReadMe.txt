========================================================================
    ZWCAD+ 二次开发程序 : QuickDim 项目概述
========================================================================


应用程序向导已为您创建了此 QuickDim DLL。  
本文件概要介绍组成 QuickDim zrx 的每个文件的内容。
...
QuickDim_z14.vcxproj
	zrx 2014 项目文件

QuickDim_z14.vcxproj.filters
